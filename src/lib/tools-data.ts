...
export const tools: ToolInfo[] = [
  ...
  { slug: 'heic-to-pdf', name: 'HEIC to PDF', description: 'Convert Apple HEIC images to PDF', icon: 'Smartphone', category: 'Create PDF', color: '#f97316' },
  { slug: 'webp-to-pdf', name: 'WebP to PDF', description: 'Convert WebP images to PDF documents', icon: 'FileImage', category: 'Create PDF', color: '#f97316' },
  { slug: 'tiff-to-pdf', name: 'TIFF to PDF', description: 'Convert TIFF images to PDF documents', icon: 'Layers', category: 'Create PDF', color: '#f97316' },
  { slug: 'svg-to-pdf', name: 'SVG to PDF', description: 'Convert SVG vector images to PDF', icon: 'FileCode', category: 'Create PDF', color: '#f97316' },
