    ...
    <div className="min-h-screen bg-gray-50/50">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {files.length === 0 ? (
          ...
          <div className="bg-white rounded-2xl border border-border shadow-sm overflow-hidden flex flex-col h-[calc(100vh-11rem)] min-h-[34rem]">
            {/* Toolbar */}
            <div className="flex flex-wrap items-center gap-x-3 gap-y-2 px-4 py-3 border-b border-border shrink-0">
              <p className="text-[13px] font-medium text-foreground truncate max-w-[12rem]" title={files[0].name}>
                {files[0].name}
              </p>
              <button
